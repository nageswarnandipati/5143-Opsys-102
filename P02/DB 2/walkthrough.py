...
def main():
   ...
   # time.sleep(2)
    ...
    print("[bold blue]Command:[/bold blue] [green]cd /Folder2[/green]")
    res = file_system.cd(location="/Folder2")
    display_pwd(res)
    file_system.command_history.append("cd /Folder2")
    #time.sleep(2)
    promot=input("Enter any key to continue \n")
    ...
    print("[bold blue]Command:[/bold blue] [green]cp Folder3 Folder1[/green]")
    res = file_system.cp(source="Folder3", destination="Folder1")
    print(res, end="\n\n")
    file_system.command_history.append("cp Folder3 Folder1")
   # time.sleep(2)
    promot=input("Enter any key to continue \n")

    print("[bold blue]Command:[/bold blue] [green]cp Folder3 Folder1[/green]")
    res = file_system.cp(source="Folder1/File2.txt ", destination="Folder4")
    print(res, end="\n\n")
    file_system.command_history.append("cp Folder3 Folder1")
    #time.sleep(2)
    promot=input("Enter any key to continue \n")
    ...
    print("[bold blue]Command:[/bold blue] [green]ls /Folder1 -l[/green]")
    data = file_system.list(path = "/Folder1",l=True)
    display_ls(data)
    file_system.command_history.append("ls /Folder1 -l")
    #time.sleep(2)
    promot=input("Enter any key to continue \n")
    ...
    data = file_system.list(l=True)
    display_ls(data)
    file_system.command_history.append("ls -l")
    #time.sleep(2)
